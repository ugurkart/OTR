function [tracker] = create_csr_tracker(img, init_bbox, mask, init_params)
...
mask_diletation_sz = 1;

tracker.init_bb = bb;
tracker.init_bb_area = bb(3) * bb(4);
...
if (init_params.use_segmentation)
...
xs = get_scale_subwindow(img, c([2,1]), base_target_sz([2,1]), currentScaleFactor * scaleSizeFactors, scale_window, scale_model_sz([2,1]), []);
